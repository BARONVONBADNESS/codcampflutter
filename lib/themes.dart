...
/// The central theme definition for the CoD Camp app.
///
/// This class is standalone and does not depend on any other app
/// modules, allowing [app.dart] and [main.dart] to both import it
...
class CodCampTheme {
  ...
  /// The dark [ThemeData] used across the whole app.
